...
export const env = createEnv({
  ...
  client: {
    ...
    NEXT_PUBLIC_STRIPE_STARTER_MONTHLY_PRICE_ID: z
      .string()
      .min(1, "NEXT_PUBLIC_STRIPE_STARTER_MONTHLY_PRICE_ID is required"),
    NEXT_PUBLIC_STRIPE_STARTER_YEARLY_PRICE_ID: z
      .string()
      .min(1, "NEXT_PUBLIC_STRIPE_STARTER_YEARLY_PRICE_ID is required"),
