...
export default function NotFound() {
  return (
    <div className="w-full flex flex-col justify-center items-center h-screen">
      ...
      <section className="mt-8 flex flex-col gap-4 text-center items-center">
        <h1 className="text-2xl">You stepped into the wrong canvas.</h1>

        <p className="font-thin">Please check the link and try again, or</p>
        <Link href="/" className="text-primary underline underline-offset-8 hover:opacity-70 transition-opacity">
          Try Your Own
        </Link>
      </section>
    </div>
