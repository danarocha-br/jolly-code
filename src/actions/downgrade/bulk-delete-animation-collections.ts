...
/**
 * Server Action: Bulk delete animation collections
 */
export async function bulkDeleteAnimationCollections(
    ...
    try {
        ...
        if (deleteError) {
            console.error('Error bulk deleting animation collections:', deleteError)
